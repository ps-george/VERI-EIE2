...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone V" ENABLE_RUNTIME_MOD="NO" INIT_FILE="../rom_data.mif" NUMWORDS_A=1024 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=10 WIDTH_BYTEENA_A=1 WIDTHAD_A=10 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_1.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_3.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_4.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_6.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_8.init_file = "../rom_data.mif",
	...
	defparam
		...
		ram_block1a_9.init_file = "../rom_data.mif",
